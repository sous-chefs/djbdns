...
describe 'djbdns_cache' do
  ...
  context 'with defaults' do
    ...
    it { is_expected.to create_systemd_unit('public-dnscache.service') }
    it { is_expected.to enable_service('public-dnscache') }
    it { is_expected.to start_service('public-dnscache') }
  ...
  context 'delete action' do
    ...
    it { is_expected.to delete_systemd_unit('public-dnscache.service') }
    it { is_expected.to delete_directory('/etc/djbdns/public-dnscache') }
  end
end
